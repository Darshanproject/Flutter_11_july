...
class _Home_ScreenState extends State<Home_Screen> {
  ...
  void deleteItem(int id)async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Your data has been deleted su"),backgroundColor: Colors.deepPurple,));
    _refreshData();
  }
    ...
    return  Scaffold(
      appBar: AppBar(
        ...
        body: _isLoading?const Center(
          ...
          itemBuilder: (context ,index)=>Card(
            ...
            child: ListTile(
              ...
              trailing: SizedBox(
                ...
                child: Row(
                  children: [
                    IconButton(onPressed: ()=>showMyForm(myData[index]['id']), icon: Icon(Icons.edit)),
                    IconButton(onPressed: ()=>deleteItem(myData[index]['id']), icon: Icon(Icons.delete))
                  ],
                ),
              ),
            ),
          ...
          floatingActionButton: FloatingActionButton(onPressed: ()=>showMyForm(null),child: Icon(Icons.add),),
